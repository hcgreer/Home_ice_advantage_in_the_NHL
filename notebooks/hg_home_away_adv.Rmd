...
```{r}
outcomes_11_12 %>% 
  saveRDS(file = '../data/outcomes_11_12.rds')

outcomes_13 %>% 
  saveRDS(file = '../data/outcomes_13.rds')

outcomes_13_14 %>% 
  saveRDS(file = '../data/outcomes_13_14.rds')

outcomes_14_15 %>% 
  saveRDS(file = '../data/outcomes_14_15.rds')

outcomes_15_16 %>% 
  saveRDS(file = '../data/outcomes_15_16.rds')

outcomes_16_17 %>% 
  saveRDS(file = '../data/outcomes_16_17.rds')

outcomes_17_18 %>% 
  saveRDS(file = '../data/outcomes_17_18.rds')

outcomes_18_19 %>% 
  saveRDS(file = '../data/outcomes_18_19.rds')

outcomes_19_20 %>% 
  saveRDS(file = '../data/outcomes_19_20.rds')

outcomes_20_21 %>% 
  saveRDS(file = '../data/outcomes_20_21.rds')

outcomes_21_22 %>% 
  saveRDS(file = '../data/outcomes_21_22.rds')

updating_elo %>% 
  saveRDS(file = '../data/updating_elo.rds')
```
